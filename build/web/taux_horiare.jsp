...
<div class="col-sm-12 col-xl-6 mt-5 mb-5" style="margin-left: auto; margin-right: auto">
    <div class="bg-light rounded h-100 p-4">
        <h6 class="mb-4">Taux horaire par type de personne</h6>
        <form method="POST" action="TauxHoraireServelet">
            
             <div class="form-floating mt-3 mb-3">
                <select class="form-select" id="floatingSelect" name="idposte"
                ...
                <label for="floatingSelect"> Choisir poste ... </label>
            </div>
